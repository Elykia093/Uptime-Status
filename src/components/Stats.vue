...
const overviewItems = computed(() => [
  { label: t('stats.totalWebsites'), value: total.value, desc: t('stats.allWebsites'), icon: 'bi:check-circle', iconColor: 'text-emerald-500', containerClass: 'after:border-emerald-500/50 dark:after:border-emerald-400/50 backdrop-blur-sm' },
  { label: t('stats.normalWebsites'), value: normal.value, desc: t('stats.accessNormal'), icon: 'bi:check-circle-fill', iconColor: 'text-green-500', containerClass: 'after:border-green-500/50 dark:after:border-green-400/50 backdrop-blur-sm' },
  { label: t('stats.abnormalWebsites'), value: abnormal.value, desc: t('stats.accessAbnormal'), icon: 'bi:x-circle-fill', iconColor: 'text-red-500', containerClass: 'after:border-red-500/50 dark:after:border-red-400/50 backdrop-blur-sm' },
  { label: t('stats.avgUptime'), value: avgUptime.value, unit: '%', desc: t('stats.last30Days'), icon: 'bi:graph-up-arrow', iconColor: 'text-blue-500', containerClass: 'after:border-blue-500/50 dark:after:border-blue-400/50 backdrop-blur-sm' }
])
